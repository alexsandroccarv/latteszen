...
window.TabConfig = (function () {
    ...
    function rscSectionHtml() {
        return `<section id="rscSection" class="bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            <h2 class="text-lg font-bold mb-2 flex items-center gap-2 flex-wrap"><i class="fa-solid fa-award text-govbr-600 dark:text-unifesp-400"></i> RSC-PCCTAE <span class="text-xs font-normal text-gray-500 dark:text-gray-400" title="Módulo disponível apenas em português do Brasil">🇧🇷 apenas em português</span></h2>
    ...
    function sumulaSectionHtml() {
        return `<section id="sumulaSection" class="bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
            <h2 class="text-lg font-bold mb-2 flex items-center gap-2 flex-wrap"><i class="fa-solid fa-file-lines text-govbr-600 dark:text-unifesp-400"></i> Súmula Curricular FAPESP <span class="text-xs font-normal text-gray-500 dark:text-gray-400" title="Módulo disponível apenas em português do Brasil">🇧🇷 apenas em português</span></h2>
