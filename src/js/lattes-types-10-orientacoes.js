...
/* ==========================================================================
   ...
   `options` viram `{ value, label }` via opcoes() — as CHAVES de
   `disabledWhen` continuam literais, batendo com `value` — ver nota de
...
export const TYPES_10_ORIENTACOES = {
    ...
    ORIENTACAO_CONCLUIDA: { label: t('lattes.tipo.ORIENTACAO_CONCLUIDA.label', 'Orientações e supervisões concluídas'), fields: [
        { key: 'tipo', label: t('lattes.tipo.ORIENTACAO_CONCLUIDA.campo.tipo.label', 'Natureza'), type: 'select', required: true, options: opcoes('orientacao_tipo', ['Iniciação científica', 'TCC / Graduação', 'Especialização / Monografia', 'Mestrado', 'Doutorado', 'Pós-Doutorado', 'Outra']) },
        { key: 'modalidade', label: t('lattes.tipo.ORIENTACAO_CONCLUIDA.campo.modalidade.label', 'Tipo'), type: 'select', options: opcoes('orientacao_modalidade', ['Acadêmico', 'Profissionalizante']), help: t('lattes.tipo.ORIENTACAO_CONCLUIDA.campo.modalidade.help', 'Apenas para Mestrado.'),
        ...
        { key: 'natureza', label: t('lattes.tipo.ORIENTACAO_CONCLUIDA.campo.natureza.label', 'Tipo de orientação'), type: 'select', options: opcoes('orientacao_natureza', ['Orientador principal', 'Coorientador']) },
    ...
    ORIENTACAO_ANDAMENTO: { label: t('lattes.tipo.ORIENTACAO_ANDAMENTO.label', 'Orientações e supervisões em andamento'), fields: [
        { key: 'tipo', label: t('lattes.tipo.ORIENTACAO_ANDAMENTO.campo.tipo.label', 'Natureza'), type: 'select', required: true, options: opcoes('orientacao_tipo', ['Iniciação científica', 'TCC / Graduação', 'Especialização / Monografia', 'Mestrado', 'Doutorado', 'Pós-Doutorado', 'Outra']) },
        { key: 'modalidade', label: t('lattes.tipo.ORIENTACAO_ANDAMENTO.campo.modalidade.label', 'Tipo'), type: 'select', options: opcoes('orientacao_modalidade', ['Acadêmico', 'Profissionalizante']), help: t('lattes.tipo.ORIENTACAO_ANDAMENTO.campo.modalidade.help', 'Apenas para Mestrado.'),
          disabledWhen: { field: 'tipo', in: ['Iniciação científica', 'TCC / Graduação', 'Especialização / Monografia', 'Doutorado', 'Pós-Doutorado', 'Outra'] } },
        ...
        { key: 'natureza', label: t('lattes.tipo.ORIENTACAO_ANDAMENTO.campo.natureza.label', 'Tipo de orientação'), type: 'select', options: opcoes('orientacao_natureza', ['Orientador principal', 'Coorientador']) },
