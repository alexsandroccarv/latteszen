...
window.LATTES_CATEGORIES = [
    ...
    { key: 'PATENTES_REGISTROS', label: 'Patentes e Registros', icon: 'fa-certificate', types: [T.PATENTE] },
    { key: 'INOVACAO', label: 'Inovação', icon: 'fa-lightbulb', types: [T.SOFTWARE, T.PRODUTO_TECNOLOGICO] },
