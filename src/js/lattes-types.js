...
const TYPES = {
    ...
    PARTICIPACAO_EVENTO: { label: 'Participação em eventos, congressos, exposições, feiras e olimpíadas', fields: [
        ...
        { key: 'cargaHoraria', label: 'Carga horária', type: 'text', placeholder: 'ex.: 8h', na: true, help: 'Campo interno do lattesZen — não existe no Currículo Lattes e não é exportado no XML.' },
        { key: 'url', label: 'Home page do trabalho (URL)', type: 'url' }] },
