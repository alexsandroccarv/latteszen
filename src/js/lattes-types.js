...
const TYPES = {
    ...
    LICENCA: { label: 'Licença maternidade', noExport: true, fields: [{ key: 'titulo', label: 'Descrição', type: 'text', required: true }, { key: 'tipo', label: 'Tipo', type: 'select', options: ['Maternidade'] }, { key: 'dataInicio', label: 'Data de início', type: 'datebr' }, { key: 'dataFim', label: 'Data de fim', type: 'datebr' }] },
