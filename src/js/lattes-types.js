...
const TYPES = {
    ...
    IDIOMAS: { label: 'Idiomas', fields: [{ key: 'titulo', label: 'Idioma', type: 'text', required: true }, { key: 'habilidades', label: 'Proficiência', type: 'checkboxes', options: ['Leitura', 'Fala', 'Escrita', 'Compreensão'] }] },
