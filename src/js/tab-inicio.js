            ...
            <div class="space-y-6 max-w-4xl">
                ...
                <section class="bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
                    ...
                    <div class="grid sm:grid-cols-2 gap-3 text-sm">
                        ...
                        <div class="flex gap-2"><i class="fa-solid fa-award text-govbr-600 dark:text-unifesp-400 mt-1"></i><span><strong>RSC sem planilha (opcional):</strong> simulador de pontuação e memorial descritivo do RSC-PCCTAE prontos a partir dos itens já cadastrados.</span></div>
                        <div class="flex gap-2"><i class="fa-solid fa-file-lines text-govbr-600 dark:text-unifesp-400 mt-1"></i><span><strong>Súmula FAPESP (opcional):</strong> roteiro da Súmula Curricular já organizado nas seções oficiais, com o texto de cada uma montado a partir dos itens já cadastrados.</span></div>
