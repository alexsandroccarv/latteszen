...
/* ==========================================================================
   ...
   ========================================================================== */
import { F_URL, F_AINI, F_AFIM, AL_ENT, AL_PAPEL, AL_FREQ, AL_IMP, AL_LOCAL, AL_ANO, alNome, opcoes, NIVEL_HABILIDADE_OPTIONS } from './lattes-types-campos.js';
...
export const TYPES_12_15_ALEM_LATTES = {
    ...
    AL_IDIOMAS: { label: t('lattes.tipo.AL_IDIOMAS.label', 'Idiomas e proficiências'), fields: [{ key: 'titulo', label: t('lattes.tipo.AL_IDIOMAS.campo.titulo.label', 'Idioma'), type: 'select', options: window.IDIOMAS, required: true }, { key: 'habilidades', label: t('lattes.tipo.AL_IDIOMAS.campo.habilidades.label', 'Proficiência (nível por habilidade)'), type: 'skilllevels', options: opcoes('idiomas_habilidades', ['Leitura', 'Fala', 'Escrita', 'Compreensão']), levels: NIVEL_HABILIDADE_OPTIONS }, { key: 'entidade', label: t('lattes.tipo.AL_IDIOMAS.campo.entidade.label', 'Onde estudou'), type: 'text' }, { ...F_AINI, row: 'periodo' }, F_AFIM, AL_IMP] },
